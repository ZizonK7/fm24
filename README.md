...
### 실력 지수 v0.1.1 제안안 — 4-2-3-1 공격형 미드필더(공격)
...
따라서 최고 속도보다는 드리블, 오프더볼, 순간속도와 민첩성의 비중을 높게 둔다.
...
이 역할에서 특히 중요하게 보는 능력치는 다음 다섯 가지다.
...
이 다섯 능력은 각각\
**좁은 공간에서의 판단, 창조성, 마지막 패스, 박스 안 마무리, 박스 밖 마무리**를 대표한다.
